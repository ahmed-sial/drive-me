    ...
    <form onSubmit={submitLoginForm}>
      <div className="h-screen flex flex-col justify-between">
        <div className="flex flex-col">
          ...
          <Button className="p-6 m-4">Login as User</Button>
          <p className="text-center">New user? <Link to="/user-register" className="text-blue-500 underline">Register now</Link></p>
        </div>
